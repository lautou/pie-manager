              ...
              <Tr key={h.ticker} style={{ backgroundColor: __idx % 2 === 0 ? '#fff' : '#f5f5f5' }}>
                ...
                <Td>
                  ...
                  {h.instrument_type === 'Or physique' && h.last_price_date && (
                    <div style={{ fontSize: '0.78rem', color: "var(--pf-t--temp--dev--tbd)"/* CODEMODS: original v5 color was --pf-v5-global--Color--200 */, marginTop: '2px' }}>
                      {h.last_price_date}
                    </div>
                  )}
                </Td>
...
export default function HoldingsPage() {
  ...
  return (
    <PageSection hasBodyWrapper={false} variant={PageSectionVariants.default}>
      ...
      <Card style={{ marginBottom: '1.5rem', borderLeft: "var(--pf-t--temp--dev--tbd)"/* CODEMODS: original v5 color was --pf-v5-global--palette--gold-400 */ }}>
        ...
        <GalleryItem>
          <Card>
            ...
            <CardBody>
              ...
              <div style={{ fontSize: '0.9rem', color: "var(--pf-t--temp--dev--tbd)"/* CODEMODS: original v5 color was --pf-v5-global--Color--200 */ }}>
            ...
            <CardTitle>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    ...
                    style={{
                      backgroundColor:
                        group.pool.strategy === 'Offensive'
                          ...
                          : "var(--pf-t--temp--dev--tbd)"/* CODEMODS: original v5 color was --pf-v5-global--palette--green-200 */,
                ...
                <span style={{ marginLeft: 'auto', fontWeight: 'normal', fontSize: '0.95rem' }}>
                  {formatEUR(poolTotal)}
                  {group.pool && (
                    <span style={{ marginLeft: '0.5rem', color: "var(--pf-t--temp--dev--tbd)"/* CODEMODS: original v5 color was --pf-v5-global--Color--200 */ }}>
