    ...
    >
      <CardTitle>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
          ...
          <span style={{ marginLeft: 'auto', fontWeight: 'normal', fontSize: '0.95rem', color: 'var(--pf-t--global--text--color--subtle)' }}>
      ...
      <CardBody>
        {account.positions.length === 0 ? (
          <Content>
            <Content component={ContentVariants.p} style={{ color: 'var(--pf-t--global--text--color--subtle)', fontStyle: 'italic' }}>
