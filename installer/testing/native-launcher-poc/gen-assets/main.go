...
// already embedded in launcher.exe/pie-manager.exe via winres, see installer/256x256.png)
// down to the sizes required by AppxManifest.xml (Square44x44Logo, Square150x150Logo).
// Replaces this poc's earlier solid-color placeholder assets (issue #82).
package main
